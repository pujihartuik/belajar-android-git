...
public class PreferencesHelper {
    ...
    private PreferencesHelper (Context contex){
        sharedPreferences = Context
                .getApplicationContext()
                .getSharedPrefences("Simple.android.app", Context.MODE_PRIVATE);
        }
    ...
    public void setLogin(boolean isCall){
        sharedPreferences.edit().putBoolean("isName", isCall).apply();
    }
